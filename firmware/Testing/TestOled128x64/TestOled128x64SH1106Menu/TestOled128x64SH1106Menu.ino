...
void loop() {
  ...
  display.onSelect(
    ...
    [](MenuCursor *cursor) {
      ...
      display.drawString(64, 3, "System Info");

      // Draw info box
      display.setColor(WHITE);
      display.drawRect(0, 15, 128, 49);

      // System information with vertically centered positions
      display.setTextAlignment(TEXT_ALIGN_LEFT);
      display.drawString(8, 20, "Temp: " + String(temperatureValue) + "C");
      display.drawString(8, 32, "Uptime: " + String(millis() / 1000) + "s");
      display.drawString(8, 44, "Memory: " + String(ESP.getFreeHeap() / 1024) + "KB");
      display.display();

      // Tunggu perintah back dari serial
  ...
  display.onSelect(
    ...
    [](MenuCursor *cursor) {
      ...
      display.setColor(BLACK);
      display.setTextAlignment(TEXT_ALIGN_CENTER);
      display.drawString(64, 3, "About Device");
      ...
      // About information
      display.setTextAlignment(TEXT_ALIGN_LEFT);
      display.drawString(8, 20, "Model: ESP32");
      display.drawString(8, 32, "FW: v1.0.0");
      display.drawString(8, 44, "SN: 12345678");
      display.display();
